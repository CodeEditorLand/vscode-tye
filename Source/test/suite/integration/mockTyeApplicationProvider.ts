...
export class MockTyeApplicationProvider implements TyeApplicationProvider {
	...
	private readonly applicationsChangedEmitter = new vscode.EventEmitter<
		TyeApplication[]
	>();

	private readonly _applications = new BehaviorSubject<TyeApplication[]>(
		MockTyeApplicationProvider.Applications
	);
