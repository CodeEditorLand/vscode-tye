...
export function isReplicaBrowsable(
	service: TyeService,
	replica: TyeReplica,
): boolean {
...
export function getReplicaBrowseUrl(
	service: TyeService,
	replica: TyeReplica,
): string | undefined {
...
export function isAttachable(service: TyeService): boolean {
	return (
		service.serviceType === "project" || service.serviceType === "function"
	);
}
...
export default class TyeReplicaNode implements TyeNode {
	...
	constructor(
		public readonly service: TyeService,
		public readonly replica: TyeReplica,
		parentId: string,
	) {
